...
<template>
  ...
  <el-card style="margin: 10px 0px">
    ...
    <el-button type="primary" size="default" :disabled="selectIdArr.length" @click="deleteSelectUser">
      批量删除
    </el-button>
...
//保存按钮的回调
const save = async () => {
  //点击保存按钮的时候,务必需要保证表单全部复合条件在去发请求,触发rules中的校验规则
